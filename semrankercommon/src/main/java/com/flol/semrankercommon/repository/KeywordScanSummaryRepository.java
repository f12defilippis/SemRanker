...
//	List<KeywordScanSummary> findByKeywordSearchengineAccountDomain_KeywordSearchengine_IdAndDateAndKeywordScanSummaryStatus_Id(Integer keywordSearchengineAccountDomainKeywordSearchengineId, Date date, Integer keywordScanSummaryStatusId);
